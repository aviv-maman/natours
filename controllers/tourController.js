...
exports.getTour = factory.getOne(Tour, { path: 'reviews' }); // { path: 'reviews', select: '__v' });
  ...
  const stats = await Tour.aggregate([
    ...
    },
    {
      $group: {
        ...
        numTours: { $sum: 1 }, // Sum each 1 document to get total
...
exports.getDistances = catchAsync(async (req, res, next) => {
  ...
  const multiplier = unit === 'mi' ? 0.000621371 : 0.001; //localhost:8000/api/v1/tours/distances/34.111745,-118.113491/unit/km
